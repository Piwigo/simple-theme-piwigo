...
<p>{'Hello'|@translate}{$USERNAME}{'nbm_content_hello_2'|@translate}</p>
...
<p>{'Go to'|@translate}<a href="{$GOTO_GALLERY_URL}">{$GOTO_GALLERY_TITLE}</a>{'nbm_content_goto_2'|@translate}</p>
{/if}
